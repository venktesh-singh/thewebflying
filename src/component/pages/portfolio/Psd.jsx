        ...
        <>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="inner-banner">
                                <div class="breadcrumb">
                                    <Link to="/"><span>Home</span></Link> <span> → </span> PSD Designing
                                </div>      
                            </div>      
                        </div>    
                    </div>    
            ...
            <section class="gallery-section">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                        <h6>Our Some Valuable Clients <br/>Recent,s PSD Designing</h6>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pdnone">
                            <div class="gallery-box zoom">
                                <a href="#" class="thumbnail">
                                <img src="assets/images/seo.PNG" alt=""/></a>
                                <div class="overlay">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pdnone">
                            <div class="gallery-box zoom">
                                <a href="#" class="thumbnail">
                                <img src="assets/images/web-development.PNG" alt=""/></a>
                                <div class="overlay">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-4 pdnone">
                            <div class="gallery-box zoom">
                                <a href="#" class="thumbnail">
                                <img src="assets/images/web-designing.PNG" alt=""/></a>
                                <div class="overlay">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pdnone">
                            <div class="gallery-box zoom">
                            <a href="#" class="thumbnail">
                                <img src="assets/images/brochur.jpg" alt=""/></a>
                                <div class="overlay">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pdnone">
                            <div class="gallery-box zoom">
                            <a href="#" class="thumbnail">
                            <img src="assets/images/psd.PNG" alt=""/></a>
                                <div class="overlay">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 pdnone">
                            <div class="gallery-box zoom">
                                <a href="#" class="thumbnail">
                                <img src="assets/images/agartala_logo.jpg" alt=""/></a>
                                <div class="overlay">
